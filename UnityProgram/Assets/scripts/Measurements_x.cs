...
public class Measurements_x : MonoBehaviour
{
    ...
    private void OnMouseDrag()
    {
        ...
        transform.position = new Vector3(GetMouseWorldPos().x + mOffset.x, gameObject.transform.position.y, gameObject.transform.position.z);
    }
